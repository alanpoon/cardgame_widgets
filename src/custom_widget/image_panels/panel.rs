...
use std;
pub trait Panelable<T> where T:Clone{
    fn x_y(&self,usize,usize)->T;
}
/// The type upon which we'll implement the `Widget` trait.
#[derive(WidgetCommon)]
pub struct ImagePanels<'a,H,T> where H:Panelable<T> {
...
impl<'a> Widget for ImagePanels<'a> {
